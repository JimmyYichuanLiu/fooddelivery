  ...
  <cube-scroll class="seller" :options="sellerScrollOptions">
    <div class="seller-content">
      <div class="overview">
        ...
        <ul class="remark">
          <li class="block">
            <h2>Minimun Order of Delivery</h2>
            <div class="content">
              <span class="stress">{{seller.minPrice}}</span>
            </div>
          </li>
          <li class="block">
            <h2>Deliver by Restaurant</h2>
            <div class="content">
      ...
      <split></split>
      <div class="bulletin">
        <h1 class="title">Discount Information</h1>
      ...
      <split></split>
      <div class="info">
        <h1 class="title border-bottom-1px">Restaurant Information</h1>
        <ul>
          <li
